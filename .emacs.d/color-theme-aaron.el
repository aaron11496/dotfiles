;;; color-theme-aaron.el --- Aaron Adelson's Color Theme
;;; based on Justin Van Winkle's Color Theme (color-theme-justin.el)

;; Copyright (C) 1997 -- 2009 Edward O'Connor <ted@oconnor.cx>
;; Copyright (C) 2010 Justin Van Winkle <justin.vanwinkle@gmail.com>

;; Author: Aaron Adelson <aaronsadelson@gmail.com>
;; Keywords: local
...
(defun hober2-use-underline-p (&optional display)
  "Non-nil if DISPLAY supports underlining. This is only sometimes accurate."
...
(defun color-theme-aaron ()
  ...
  (color-theme-install
   `(color-theme-aaron
     ...
     (font-lock-comment-delimiter-face ((t (:foreground "medium blue"))))
     ...
     (font-lock-warning-face ((t (:background "indian red"
                                  :foreground "white"))))
     ...
     (change-log-acknowledgement-face ((t (:background "cadet blue"
                                           :foreground "gray4"))))

     (comint-highlight-input ((t (:bold t))))
     (comint-highlight-prompt ((t (:foreground "pale violet red"))))

     (compilation-warning-face ((t (:background "indian red"
                                    :foreground "white"))))
     ...
     (ediff-current-diff-face-Ancestor ((t (:background "indian red"
     ...
     (ediff-even-diff-face-Ancestor ((t (:background "indian red"
                                         :foreground "light gray"
                                         :bold t))))
     ...
     (help-argument-name ((t (:foreground "indian red"))))
     ...
     (js2-function-param-face ((t (:foreground "indian red"))))
     (js2-instance-member-face ((t (:foreground "indian red"))))
     ...
     (js2-private-member-face ((t (:foreground "indian red"))))
     (js2-regexp-face ((t (:foreground "khaki"))))
     (js2-string-face ((t (:foreground "dark slate gray"))))
     (js2-type-face ((t (:foreground "medium sea green"))))
     (js2-variable-name-face ((t (:foreground "indian red"))))
     (js2-warning-face ((t (:background "indian red" :foreground "white"))))

     (makefile-shell-face ((t ())))
     (makefile-space-face ((t (:background "indian red" :foreground "light gray"))))
     ...
     (nxml-char-ref-number ((t (:foreground "indian red"))))
     (nxml-char-ref-delimiter ((t (:foreground "indian red"))))
     (nxml-entity-ref-name ((t (:foreground "indian red"))))
     (nxml-entity-ref-delimiter ((t (:foreground "indian red"))))
     ...
     (show-tabs-space ((t (:background "indian red" :foreground "light gray"))))
     (show-tabs-space-face ((t (:background "indian red" :foreground "light gray"))))
     (show-tabs-tab ((t (:background "indian red" :foreground "light gray"))))
     (show-tabs-tab-face ((t (:background "indian red" :foreground "light gray"))))
     ...
     (sldb-local-name-face ((t (:foreground "indian red"))))
     ...
     (sldb-topline-face ((t (:foreground "indian red"))))
     ...
     (trailing-whitespace ((t (:background "indian red" :foreground "light gray"))))
     ...
     (whitespace-highlight-face ((t (:background "indian red" :foreground "light gray"))))
